...
For working with `.eldat` files you only need the `schema_de.json` file which contains the complete .eldat 1.0.4 data format definition with German titles and descriptions.

### How to validate .eldat 1.0.4 files
...
3. Validate your `JSON` against the provided `schema_de.json` to ensure that it corresponds to a valid eldat 1.0.4 document
